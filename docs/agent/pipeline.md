...
> **Known Issue (2026-03-12):** Gemini Realtime의 `gemini-2.5-flash-native-audio-preview-12-2025` 모델에서 function calling(tool use)과 실시간 오디오 스트리밍을 함께 사용할 때 WebSocket 1008 (Policy Violation) 에러로 세션이 간헐적으로 종료될 수 있습니다. 이는 Google Gemini Live API의 서버 측 알려진 이슈입니다.
